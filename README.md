...
2. Поддержка до `5*10^5` котов с минимальной возможно частотой `7 FPS`
    ...
    * **ВАЖНО: эти показатели сильно зависят от:**
      ...
      > ![500_000_cats](https://github.com/user-attachments/assets/1f7bd6ca-0a7c-41f9-b8b9-d0b8a3052246)
...
1. "**Вид от третьего лица**"
	...
	* Фокусировка на **любимых** котах -- **любимые** коты имеют "сектор обзора", направленный по ходу движения. Яркими цветами выделяются **остальные** коты, которые попадают в этот сектор.
		> Дрон примерно догадывается кого видит каждый **любимый** кот. Пририсовывает коту линии обзора (две белые линии), ограничивающее сектор обзора.
  
		> ![focusing_on_fav_cat](https://github.com/user-attachments/assets/ab490cfb-0dd5-4542-9e2c-a5a658bbd4b8)
	* Отсутствие фокусировки -- **любимые** коты имеют отличительную окраску *(чтоб можно было понять, какие коты являются **остальными**)*
		> Дрон выделяет **любимых** котов.
  		...
  		> ![no_focusing_on_fav_cat](https://github.com/user-attachments/assets/c3de2e26-d39e-44d6-80b9-dd2790827def)
2. "**Логирование любимых котов**"
	...
	> ![cat_logging](https://github.com/user-attachments/assets/b595879f-e3b0-4b78-8e15-0c7ef91fe3d9)
